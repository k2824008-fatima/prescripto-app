...
// export default function Appointment({ appointments, setAppointments }) {
...
//       <div style={{display:"flex", gap:"30px", marginBottom:"50px", alignItems:"flex-start"}}>
//         <img src={doctor.img} alt={doctor.name}
//           style={{width:"220px", height:"260px", objectFit:"cover", borderRadius:"12px", background:"#5f6FFF", flexShrink:0}} />
...
//                   style={{
//                     textAlign:"center", borderRadius:"50px", padding:"10px 14px",
...
//               <div style={{display:"flex", gap:"8px", flexWrap:"nowrap", overflowX:"auto", marginBottom:"20px"}}>
...
//               style={{background:"#5f6FFF", color:"white", border:"none", padding:"12px 40px", borderRadius:"50px", fontSize:"15px", cursor:"pointer", marginTop:"10px"}}>
//               Book an appointment
//             </button>
//           </div>
//         </div>
...
//             .map(d => (
//               <div key={d.id}
//                 onClick={() => window.location.href = `/appointment/${d.id}`}
//                 style={{border:"1px solid #ddd", borderRadius:"12px", width:"190px", cursor:"pointer", overflow:"hidden"}}>
//                 <img src={d.img} alt={d.name}
//                   style={{width:"100%", height:"210px", objectFit:"cover", background:"#eef"}} />
...
//   // ✅ Apni real login check se replace karo
//   // Example: const isLoggedIn = !!localStorage.getItem('user')
...
//         navigate('/login') // ya '/create-account' — apna route likho
//       }, 2000)
//       return
//     }
